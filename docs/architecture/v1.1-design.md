...
`.delta/` stores complete, independent snapshots of all Agent executions using this CWD. This implements "time machine" functionality and supports iterative workflows.
