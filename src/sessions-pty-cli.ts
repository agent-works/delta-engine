...
import { SessionManager } from './sessions-pty/manager.js';
import { parseEscapeSequences } from './sessions-pty/escape-parser.js';
import { getKeyCode, isValidKey } from './sessions-pty/key-codes.js';
import type {
  StartResult,
  WriteResult,
  WriteKeyResult,
...
function printHelp(): void {
  console.log(`
delta-sessions-pty - [EXPERIMENTAL] Manage PTY-based interactive process sessions

⚠️  WARNING: This is an experimental feature. Use delta-sessions instead for production.

USAGE:
  delta-sessions-pty <command> [options]
...
function printVersion(): void {
  ...
  console.log('delta-sessions-pty v1.4.2 [EXPERIMENTAL]');
}
