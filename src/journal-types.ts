...
export const ThoughtPayloadSchema = z.object({
  ...
  llm_invocation_ref: z.string().uuid(), // Reference to runtime_io/invocations/<UUID>/
...
export const ActionResultPayloadSchema = z.object({
  ...
  execution_ref: z.string(), // Reference to runtime_io/tool_executions/<ACTION_ID>/
});
...
export const HookExecutionAuditPayloadSchema = z.object({
  ...
  io_path_ref: z.string(), // Relative path to runtime_io/hooks/<Step>_<HookName>/
});
